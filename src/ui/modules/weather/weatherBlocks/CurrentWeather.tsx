        ...
        <div className="border-solid w-[100%] bg-gradient-radial rounded-[20px] text-whiteM p-6 md:h-[330px] flex flex-col justify-between">
            <div className="flex flex-row justify-between items-start">
                ...
                <div className="flex flex-row">
                    <button type="submit" className="bg-[#002518] rounded-full px-4 animate-pulse">
                        F
                    </button>
                    <button type="submit" className="bg-whiteM text-blackM rounded-full px-4">
                        C
                    </button>
                </div>
            </div>
            ...
            <div className="flex justify-between items-center">
                ...
                <div className="flex flex-col items-end mt-[-40px]">
                    <Icons currentStatus={data.current.weather[0].main} className='w-[120px] h-[120px] md:w-[180px] md:h-[180px]'/>
